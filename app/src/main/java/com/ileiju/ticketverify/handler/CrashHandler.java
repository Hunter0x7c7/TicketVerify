package com.ileiju.ticketverify.handler;
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (FileUtil.existsSdcard()) {
                ...
                path = storageDirectory + "/" + mContext.getPackageName() + "/crash";
                File dir = new File(path);
                if (!dir.exists()) {
                    dir.mkdirs();
                }
            } else {
                path = mContext.getDir("crash", Context.MODE_PRIVATE).getAbsolutePath();
            }
